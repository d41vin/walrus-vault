[llms.txt](https://sdk.mystenlabs.com/llms.txt)

@mysten/sui v2.0 and a new dApp Kit are here! [Check out the migration guide](https://sdk.mystenlabs.com/sui/migrations/sui-2.0)
...
## [Installation](https://sdk.mystenlabs.com/walrus\#installation)

```
npm install --save @mysten/walrus @mysten/sui
```

## [Setup](https://sdk.mystenlabs.com/walrus\#setup)
...
## [`WalrusFile` API](https://sdk.mystenlabs.com/walrus\#walrusfile-api)
...
### [Reading files](https://sdk.mystenlabs.com/walrus\#reading-files)
...
#### [`WalrusBlob`](https://sdk.mystenlabs.com/walrus\#walrusblob)
...
### [Writing files](https://sdk.mystenlabs.com/walrus\#writing-files)
...
#### [Writing files in browser environments](https://sdk.mystenlabs.com/walrus\#writing-files-in-browser-environments)
...
### [Running the full flow](https://sdk.mystenlabs.com/walrus\#running-the-full-flow)
...
#### [Resuming uploads](https://sdk.mystenlabs.com/walrus\#resuming-uploads)
...
## [Using an upload relay](https://sdk.mystenlabs.com/walrus\#using-an-upload-relay)
...
### [`const` tip](https://sdk.mystenlabs.com/walrus\#const-tip)
...
### [`linear` tip](https://sdk.mystenlabs.com/walrus\#linear-tip)
...
## [Interacting with blobs directly](https://sdk.mystenlabs.com/walrus\#interacting-with-blobs-directly)

If you do not want to use the `WalrusFile` abstractions, use the `readBlob` and `writeBlob` APIs
directly.

### [Reading blobs](https://sdk.mystenlabs.com/walrus\#reading-blobs)
...
### [Writing blobs](https://sdk.mystenlabs.com/walrus\#writing-blobs)
...
## [Error handling](https://sdk.mystenlabs.com/walrus\#error-handling)
...
### [Network errors](https://sdk.mystenlabs.com/walrus\#network-errors)
...
## [Configuring network requests](https://sdk.mystenlabs.com/walrus\#configuring-network-requests)
...
## [Loading the WASM module in Vite or client-side apps](https://sdk.mystenlabs.com/walrus\#loading-the-wasm-module-in-vite-or-client-side-apps)
...
## [Known fetch limitations](https://sdk.mystenlabs.com/walrus\#known-fetch-limitations)
...
## [Full API](https://sdk.mystenlabs.com/walrus\#full-api)

For a complete overview of the available methods on the `WalrusClient`, reference the
[TypeDocs](https://sdk.mystenlabs.com/typedoc/classes/_mysten_walrus.WalrusClient.html).

## [Examples](https://sdk.mystenlabs.com/walrus\#examples)
...
[Edit on GitHub](https://github.com/MystenLabs/ts-sdks/blob/main/packages/docs/content/walrus/index.mdx)

### On this page

[Installation](https://sdk.mystenlabs.com/walrus#installation) [Setup](https://sdk.mystenlabs.com/walrus#setup) [`WalrusFile` API](https://sdk.mystenlabs.com/walrus#walrusfile-api) [Reading files](https://sdk.mystenlabs.com/walrus#reading-files) [`WalrusBlob`](https://sdk.mystenlabs.com/walrus#walrusblob) [Writing files](https://sdk.mystenlabs.com/walrus#writing-files) [Writing files in browser environments](https://sdk.mystenlabs.com/walrus#writing-files-in-browser-environments) [Running the full flow](https://sdk.mystenlabs.com/walrus#running-the-full-flow) [Resuming uploads](https://sdk.mystenlabs.com/walrus#resuming-uploads) [Using an upload relay](https://sdk.mystenlabs.com/walrus#using-an-upload-relay) [`const` tip](https://sdk.mystenlabs.com/walrus#const-tip) [`linear` tip](https://sdk.mystenlabs.com/walrus#linear-tip) [Interacting with blobs directly](https://sdk.mystenlabs.com/walrus#interacting-with-blobs-directly) [Reading blobs](https://sdk.mystenlabs.com/walrus#reading-blobs) [Writing blobs](https://sdk.mystenlabs.com/walrus#writing-blobs) [Error handling](https://sdk.mystenlabs.com/walrus#error-handling) [Network errors](https://sdk.mystenlabs.com/walrus#network-errors) [Configuring network requests](https://sdk.mystenlabs.com/walrus#configuring-network-requests) [Loading the WASM module in Vite or client-side apps](https://sdk.mystenlabs.com/walrus#loading-the-wasm-module-in-vite-or-client-side-apps) [Known fetch limitations](https://sdk.mystenlabs.com/walrus#known-fetch-limitations) [Full API](https://sdk.mystenlabs.com/walrus#full-api) [Examples](https://sdk.mystenlabs.com/walrus#examples)